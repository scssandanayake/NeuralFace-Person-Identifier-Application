...
import 'controller/onboarding_screens_three_controller.dart';

// ignore_for_file: must_be_immutable
class OnboardingScreensThreeScreen
    extends GetWidget<OnboardingScreensThreeController> {
  const OnboardingScreensThreeScreen({Key? key})
      : super(
          key: key,
        );
